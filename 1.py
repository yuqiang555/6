...
def load_data():
    # 读取加州迪士尼的数据
    california_data = pd.read_excel('D:\User\深度学习期末 (2)\深度学习期末\Disneyland_California.xlsx')
    # 读取香港迪士尼的数据
    hongkong_data = pd.read_excel('D:\User\深度学习期末 (2)\深度学习期末\Disneyland_HongKong.xlsx')
    # 读取巴黎迪士尼的数据
    paris_data = pd.read_excel('D:\User\深度学习期末 (2)\深度学习期末\Disneyland_Paris.xlsx')
    # 读取随机抽取的评价样本数据
    reviews_data = pd.read_excel('D:\User\深度学习期末 (2)\深度学习期末\Sampled_DisneylandReviews.xlsx')
    # 返回一个包含所有数据的字典
...
# 显示 Excel 文件内容
excel_file_path = 'D:\User\深度学习期末 (2)\深度学习期末\recommended_reviews_new_user_670801368.xlsx'
